...
{
    public partial class UcReporteInquilinos : UserControl
    {
        ...
        public UcReporteInquilinos(DateTime desde, DateTime hasta)
        {
        ...
        private void BuildUi()
        {
            ...
            header.Controls.Add(new Label { Text = "Top Inquilinos por Monto Pagado", AutoSize = true, ForeColor = Color.White, Font = new Font("Segoe UI", 12, FontStyle.Bold) });
            ...
            var c1 = UiTheme.KpiCard("Ingresos de Top", out lblTotal, UiTheme.Primary);
            ...
            export.Click += (s, e) => GridExporter.ExportToCsv(grid, "inquilinos.csv");
        ...
        {
            var data = _repo.ObtenerTopInquilinos(_desde, _hasta, 20);
            grid.DataSource = data;
            lblTotal.Text = data.Sum(x => x.TotalPagado).ToString("C2");
        }
    }
}
